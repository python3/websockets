"""
:mod:`websockets.handshake` deals with the WebSocket opening handshake per
`section 4 of RFC 6455`_.
...
def build_request(headers: Headers) -> str:
    ...
    Updates request headers passed in argument.
...
def build_response(headers: Headers, key: str) -> None:
    ...
    Updates response headers passed in argument.
